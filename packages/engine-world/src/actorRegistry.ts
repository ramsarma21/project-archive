...
export interface GameplayActor {
  ...
  kind: ActorKind;
  position: ActorVec3;
  forwardVec: ActorVec3; // unit-ish planar facing; watchers use it as the cone axis
  velocity?: ActorVec3; // present for moving actors (pursuers/patrols); omitted if static
...
function copyVec(v: Vec3Like): ActorVec3 {
