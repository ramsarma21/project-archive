...
export const ASSETS: AssetRequirement[] = [
  ...
  { key: "bldg-merchant", status: "EXISTING", path: "world/props/bldg-merchant.glb", sizeM: [9, 7.1, 14], why: "The merchant's house (Thomas) — the mission's SECOND enterable interior, generated the printshop way (build_civic_facade shell mode). A Georgian brick facade with a real open upper window on the south (no door) and a solid parlour floor at 4.0 you HANG_DROP onto off the eave. Supersedes the sugar house; 9 m wide to clear the Town House scaffold approach." },
