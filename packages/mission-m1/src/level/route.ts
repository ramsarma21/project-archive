...
export const LINKS: RouteLink[] = [
  ...
  link("M_PARLOUR", "M_STRING", "CLIMB", "SAFE", "CLIMB", {
    // traversability's generic endpoint chord crosses the roof plane; the
    // shipped reader's measured rise-then-land plan is independently required
    // by ladderOffers and the drawn-mesh sweep.
