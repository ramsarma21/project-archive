...
// ============================================================================
// TEKS coverage map (Boston chapter). Backs POV 6: "the whole standard gets
// taught, not the convenient parts." Every gated concept maps to a
// STAAR-eligible Grade 8 Social Studies TEKS clause; the coverage table shows
// where each is taught and assessed, and which clauses are scheduled later.
...
// Concept -> TEKS clause.
export const CONCEPT_TEKS: Record<string, TeksClause> = {
