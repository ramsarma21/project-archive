...
import { MICRO_CONCEPT_IDS, OPTIONAL_ACTIVITY_IDS, THREAD_IDS } from "../src/fieldIds.js";
...
// Tavern note and dock haul preserve custody and charge time only at completion.
{
  ...
  runExchange(session, "tavern-accept", {
    ...
    sourceId: "NPC-thomas",
    outcomeId: "TAKE_NOTE",
    activities: [{ activityId: OPTIONAL_ACTIVITY_IDS.TAVERN_NOTE, stage: "ACCEPTED" }],
  ...
  runExchange(session, "tavern-deliver", {
    ...
    outcomeId: "HANDOFF",
    activities: [{ activityId: OPTIONAL_ACTIVITY_IDS.TAVERN_NOTE, stage: "COMPLETED" }],
  ...
  runExchange(session, "dock-accept", {
    ...
    outcomeId: "ACCEPT",
    activities: [{ activityId: OPTIONAL_ACTIVITY_IDS.DOCK_HAUL, stage: "ACCEPTED" }],
  });
  runExchange(session, "dock-lift", {
    interactionId: "dock:lift",
    sourceId: "SJ-dock-haul-lift",
    outcomeId: "LIFT",
    activities: [{ activityId: OPTIONAL_ACTIVITY_IDS.DOCK_HAUL, stage: "CARRYING" }],
  ...
  runExchange(session, "dock-balance", {
    ...
    outcomeId: "BALANCE",
    activities: [{ activityId: OPTIONAL_ACTIVITY_IDS.DOCK_HAUL, stage: "READY_HANDOFF" }],
  });
  ...
  runExchange(session, "dock-setdown", {
    ...
    outcomeId: "SET_DOWN",
    activities: [{ activityId: OPTIONAL_ACTIVITY_IDS.DOCK_HAUL, stage: "COMPLETED" }],
