...
Related: `World-Built-State.md` (current built state), `Production.md` (pipeline + no-mocap laws), `packages/chapter-boston-world/src/world/manifest.ts` (machine-readable layout).
