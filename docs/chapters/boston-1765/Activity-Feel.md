...
**Companions:** activities = `Activity-Expansion.md`; mechanics = `Mechanics-Spec.md`; camera/feedback grammar = `Interaction-Spec.md` §5/§9 + `Production.md` §2A; rigs = `packages/chapter-boston-world/src/world/MechanicRigs.tsx`; audio = `apps/web/public/audio/` (`press-shop`, `church-bell`, `market-clatter`, `gull-cry`, `harbor-lap`, `cart-passby`, `street-murmur`, `door-creak`, `dog-bark`, `wind-gusts`, `rain-bed`, `room-tone`, `church-hush`).
