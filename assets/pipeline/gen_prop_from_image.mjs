// Generate a textured game prop from a single reference image without forcing
// character T/A-pose normalization.
// Usage: node assets/pipeline/gen_prop_from_image.mjs reference.png output.glb
import { readFileSync, writeFileSync, mkdirSync } from "node:fs";
import { resolve, dirname, extname } from "node:path";

const [, , imageArg, outputArg] = process.argv;
if (!imageArg || !outputArg) {
  console.error("usage: node assets/pipeline/gen_prop_from_image.mjs reference.png output.glb");
  process.exit(1);
}
